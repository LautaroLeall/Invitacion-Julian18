  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className="absolute top-1/2 z-10 hidden w-[clamp(88px,21vmin,180px)] cursor-pointer rounded-[14px] opacity-95 drop-shadow-[0_12px_20px_rgba(0,0,0,0.45)] sm:block left-[clamp(-24px,-3.4vmin,-8px)]"
        src="/cancha-boca.png"
        alt="Bombonera"
      />
