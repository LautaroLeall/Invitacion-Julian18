...
import { Church, ArrowLeft, Star, CalendarDays, MapPin } from "lucide-react";
import Countdown from "./Countdown";
import RSVPForm from "./RSVPForm";

export default function Misa({ onNavigate }) {
  return (
    <motion.section
      ...
      style={{
        background:
          "radial-gradient(ellipse at 50% -6%, #1a3a86, var(--color-navy-950) 62%)",
      }}
    >
      {/* Background elements */}
      ...
      <motion.img
        ...
        className="pointer-events-none absolute top-1/2 z-10 hidden w-[clamp(88px,21vmin,180px)] rounded-[14px] opacity-95 drop-shadow-[0_12px_20px_rgba(0,0,0,0.45)] sm:block left-[clamp(-24px,-3.4vmin,-8px)]"
        src="./cancha-boca.png"
        alt="Bombonera"
      />
      ...
      <div className="relative z-20 flex h-full flex-col overflow-y-auto overflow-x-hidden p-[clamp(10px,3.6vmin,30px)_clamp(14px,5vmin,40px)]">
        ...
        <div className="mx-auto flex w-full max-w-115 flex-1 flex-col items-center justify-center gap-6 pb-12 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              ...
              <p className="m-0 mt-2 max-w-xs text-sm font-medium text-[#c3cbe6]">
                Acompáñanos a dar gracias en un momento especial en familia
                antes de la gran celebración.
              </p>
            </div>
          </div>

          <div className="my-2">
            <Countdown targetDate="2026-10-01T20:00:00-03:00" />
          </div>
          ...
          <div className="flex w-full flex-col gap-6 rounded-2xl bg-linear-to-b from-white/5 to-transparent p-6 sm:flex-row sm:gap-4">
            <div className="flex flex-1 flex-col items-center gap-2">
              ...
              <p className="m-0 text-sm font-medium text-[#c3cbe6]">20:00 hs</p>
            </div>

            <a
              href="https://maps.app.goo.gl/C3RQx9EZ6qv7XzD87"
              target="_blank"
